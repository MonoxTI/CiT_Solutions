...
const services = ["Networking Solutions", "CCTV & Surveillance", "Managed IT Services", "Server Infrastructure", "Smart School Solutions", "Wireless & WiFi"];
  ...
  return (
    <section id="home" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden", background: "#000" }}>
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
        ...
        />
        {/* Dark overlay */}
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, #000 0%, rgba(0,0,0,0.7) 50%, #000 100%)" }} />
      </div>

      {/* Dot grid */}
      <div style={{ position: "absolute", inset: 0, backgroundImage: "radial-gradient(circle, rgba(255,255,255,0.04) 1px, transparent 1px)", backgroundSize: "32px 32px", zIndex: 1, pointerEvents: "none" }} />

      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "9rem 2.5rem 5rem", width: "100%", display: "grid", gridTemplateColumns: "1fr 420px", gap: 80, alignItems: "center", position: "relative", zIndex: 2 }} className="hero-grid">
      ...
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 140, background: "linear-gradient(to top, #000, transparent)", pointerEvents: "none", zIndex: 2 }} />
