...
export default function Contact() {
  ...
  return (
    <section id="contact" style={{ padding: "6rem 0", background: "#000", backgroundImage: "radial-gradient(circle, rgba(255,255,255,0.025) 1px, transparent 1px)", backgroundSize: "32px 32px" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2.5rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }} className="contact-grid">
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 44 }}>
              {[
                ...
                <div key={c.label} style={{ display: "flex", alignItems: "center", gap: 16, padding: "16px 18px", background: "#080808", border: "1px solid #1A1A1A", borderRadius: 3, transition: "border-color 0.2s" }}
          ...
          {/* Form */}
          <div style={{ background: "#080808", border: "1px solid #1E1E1E", borderRadius: 4, padding: "44px 36px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              <button onClick={onSubmit}
                style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, background: "#fff", color: "#000", fontFamily: "Syne,sans-serif", fontWeight: 700, fontSize: "0.8rem", letterSpacing: "0.1em", textTransform: "uppercase", padding: "14px 0", borderRadius: 3, border: "none", cursor: "pointer", transition: "all 0.2s", marginTop: 4 }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = "#C0C0C0"; (e.currentTarget as HTMLElement).style.transform = "translateY(-1px)"; }}
